...
export const metadata: Metadata = {
  ...
  description:
    "LPG Go PH safety and precaution manual for customers, riders, and dealers.",
};
...
export default function SafetyPage() {
  return (
    <PolicyLayout
      eyebrow="Kaligtasan"
      title="Safety Manual"
      lead="A practical LPG safety center for households, riders, and dealers, with emergency guidance and operational checklists."
    >
      <section className="safety-hero-panel">
        <div>
          ...
          <p>
            Leak reports are treated as safety-priority tickets with a 1-hour
            first response target. Keep the tank upright, ventilate, and move
            people away before filing the report.
          </p>
          <a className="btn" href="/kaligtasan/emergency">
