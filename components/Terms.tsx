    ...
    <section id="terms">
      <div className="wrap">
        <div className="center" style={{ marginBottom: 36 }}>
          ...
          <h2 className="title reveal d1">Terms &amp; Conditions</h2>
        </div>
        <div className="doc reveal d1">
          ...
          <h3>1. Platform Role and Parties to a Sale</h3>
          <p>
            LPG Go is a digital marketplace, ordering, verification,
            monitoring, payment-coordination, and support platform. LPG Go does
            not store, refill, decant, own, manufacture, or directly sell LPG.
            LPG products and accessories are listed, sold, invoiced, delivered,
            and fulfilled by independent participating dealers/retailers.
          </p>
          <p>
            Unless a screen expressly states otherwise, the sales contract for
            an LPG product is between the customer and the selected
            dealer/retailer. A rider may be an employee, contractor, or
            authorized delivery representative of a dealer/retailer. LPG Go may
            facilitate records, communications, evidence, payments, support,
          ...
          <ul>
            <li>Users must have legal capacity to enter the transaction and must use accurate, current information.</li>
            <li>Each user is responsible for protecting login credentials, devices, verification codes, and authorized account access.</li>
            <li>A business account may be used only by its owner and properly authorized personnel.</li>
            <li>Actions completed through an authenticated account may be treated as authorized unless promptly reported as compromised.</li>
            <li>Users consent to electronic notices, receipts, records, approvals, and signatures to the extent permitted by law.</li>
          </ul>
          <p>
            LPG Go may request identity or authority verification before
            activating an account, changing sensitive details, processing a
          ...
          <p>
            ...
            permit, DTI or SEC registration, BIR registration, DOE License to
            Operate, Fire Safety Inspection Certificate or related BFP
            compliance, authority to sell a particular LPG trademark or trade
            name, supplier or source documents, valid identification, store
          ...
          <p>
            ...
            LPG Go may restrict a store or brand listing while documents are
            missing, expired, inconsistent, or under review.
          </p>

          <h3>4. Verification Is Not a Government License or Guarantee</h3>
          <p>
            LPG Go verification means that submitted information has undergone
            platform onboarding review and may have been compared with available
            public or official records. It is not a DOE, LGU, BFP, DTI, SEC,
            BIR, court, brand-owner, or other government certification. A
            verification badge is not a guarantee of continuous compliance,
            product quality, inventory, delivery performance, or the truth of
            every later representation.
          </p>
          <p>
            Customers should inspect products and report concerns. Government
            agencies and brand owners retain their own authority to inspect,
          ...
          <ul>
            ...
            <li>order acceptance, preparation, rider assignment, delivery fulfillment, warranties, returns, replacements, refunds, and after-sales obligations;</li>
            <li>training, supervising, screening, paying, and lawfully engaging its riders and personnel;</li>
            <li>compliance with LPG, consumer, fire-safety, labor, tax, privacy, transportation, and local rules applicable to its operations; and</li>
          ...
          <p>
            ...
            delivery completion, failed-delivery reasons, cash collection, or
            refund confirmation. A reschedule or failed-delivery action after
            pickup may require customer notice, location and time evidence, and
          ...
          <p>
            ...
            instructions; select the correct brand, size, and order type; remain
            reasonably available to receive the order; and provide a compatible
            empty cylinder when a refill exchange requires one.
          </p>
          <p>
            The customer or authorized recipient must inspect the brand, size,
            seal, visible cylinder condition, order completeness, and amount due
            before acceptance when practical. Leaks, unsafe cylinders, wrong
            items, suspected underweight, damage, overcharging, non-delivery, or
            another issue must be reported truthfully through the order screen
          ...
          <p>
            ...
            ledger, enrollment terms, or transaction record.
          </p>
          <p>
            A previous amount is not a promise of a future fee. LPG Go will not
            retroactively change a completed customer total except to correct an
            error, apply an agreed remedy, comply with law, or reverse a
            transaction.
          </p>
          ...
          <p>
            ...
            Available methods are shown at checkout. Third-party payment
            processing is governed by the provider&apos;s terms, verification,
            limits, availability, reversals, and processing times.
          </p>
          <p>
            LPG Go does not ask users to disclose a banking password, card PIN,
            or e-wallet PIN and does not store full card or bank credentials in
            the app. Users must not initiate a false chargeback, submit a false
            payment receipt, collect an amount outside the order record, or
          ...
          <p>
            ...
            customer availability, and other local conditions. GPS and status
            updates may be delayed, approximate, or unavailable and are not a
            guarantee of an exact location or arrival time.
          </p>
          <p>
            LPG Go may collect status history, server timestamps, GPS,
            pickup/delivery photos, contact attempts, communications, and
            payment records for coordination, safety, fraud prevention, and
          ...
          <p>
            ...
            cancellation or failed delivery may require evidence and review.
            Eligible orders may show Return and Full Refund for 30 minutes after
            Delivered and Return and Replace for one hour after Completed. After
            those actions expire, users may use Report or Dispute. Safety
            concerns remain reportable.
          </p>
          <p>
            A request is not an automatic approval. Remedies may include
            redelivery, replacement, partial adjustment, full refund, or denial
            with a reason. Cylinder retrieval, inspection, and in-app
            confirmation may be required. See the{" "}
            <a href="/policy/refund-policy">
              Return, Replacement, and Refund Policy
            </a>{" "}
            for the operational process. No policy limits a non-waivable
            consumer remedy.
          </p>
          ...
          <p>
            ...
            or is visibly unsafe. In an uncontrolled leak or fire, move away and
            contact emergency responders before using the app.
          </p>
          <p>
          ...
          <p>
            ...
            risk flags to prioritize review, but a flag is not a final finding
            of fault. Authorized administrators may request more information,
            preserve a fee or payment hold, restrict account actions, or issue a
            reasoned resolution.
          </p>
          <p>
            Off-app arrangements may not be recognized because LPG Go cannot
            verify their terms, payment, product identity, or completion.
            Nothing prevents a user from exercising a lawful right to contact
          ...
          <ul>
            ...
            <li>fake orders, collusion, fee evasion, false delivery or non-delivery claims, GPS manipulation, repeated abusive cancellations, or refund abuse;</li>
            <li>harassment, discrimination, threats, violence, privacy invasion, or misuse of contact and location data;</li>
            <li>unauthorized access, scraping, malware, reverse engineering where prohibited, interference with security, or use of the service for unlawful activity; and</li>
          ...
          <p>
            ...
            access, payout, SCC-supported action, or other feature when
            reasonably necessary for safety, expired or invalid documents,
            suspected fraud, repeated service failures, unpaid obligations,
            legal compliance, investigation, or breach of these Terms.
          </p>
          <p>
            Where appropriate, LPG Go will provide notice or an opportunity to
            respond. Immediate action may be taken for urgent safety, security,
            fraud, legal, or evidence-preservation concerns. Termination does not
            erase accrued payment, refund, tax, indemnity, investigation, or
          ...
          <p>
            ...
            payment providers, banks, e-wallets, and other third parties. Their
            outages, limits, terms, and technical behavior may affect the
            service. LPG Go may maintain, change, suspend, or discontinue a
            feature, subject to applicable law and existing transaction
            obligations.
          </p>
          ...
          <p>
            ...
            exploited without permission. Product brands and third-party marks
            remain the property of their owners.
          </p>
          <p>
            A user retains rights in content the user lawfully submits. The user
            grants LPG Go a non-exclusive, worldwide, royalty-free license to
            host, reproduce, process, display, and share that content only as
            reasonably necessary to operate, secure, improve, document, and
            enforce the service, resolve disputes, and comply with law. The user
            confirms authority to submit the content and must avoid unnecessary
          ...
          <p>
            LPG Go remains responsible for its own obligations to the extent
            required by law. No exclusion applies to fraud, willful misconduct,
            gross negligence, death or personal injury where liability cannot be
            excluded, violation of the Data Privacy Act, or another liability
            that Philippine law does not allow a party to waive. To the extent
            lawful, LPG Go excludes indirect, incidental, special,
            consequential, exemplary, or lost-profit damages that were not the
          ...
          <p>
            ...
            penalties, losses, and reasonable costs caused by that user&apos;s
            unlawful product, false document or listing, employment or tax
            obligation, privacy violation, infringement, fraud, willful
            misconduct, or material breach of these Terms. This clause does not
            require indemnity for LPG Go&apos;s own unlawful conduct, gross
          ...
          <p>
            ...
            use the in-app support or dispute process and allow a reasonable
            opportunity for a documented response, unless urgent relief or a
            statutory deadline requires otherwise.
          </p>
          <p>
            Nothing prevents a customer from using DTI consumer complaint
            channels, a data subject from filing with the National Privacy
            Commission, a regulator from exercising lawful authority, or a party
            from seeking relief in a court or forum with jurisdiction. Any venue
          ...
          <p>
            ...
            effective date and, when required, an additional notice or renewed
            consent. Changes do not retroactively remove accrued mandatory
            rights.
          </p>
          <p>
            If one provision is unenforceable, the remaining provisions continue
            to apply and the affected provision will be interpreted as closely
            as lawful to its purpose. Failure to enforce a provision is not a
            waiver. LPG Go may assign these Terms in connection with a lawful
            reorganization, financing, or transfer of the service, with
            appropriate notice and data-protection measures. Users may not
          ...
          <ul>
            <li>
              <a href="https://lawphil.net/statutes/repacts/ra2021/ra_11592_2021.html" target="_blank" rel="noopener noreferrer">
                Republic Act No. 11592, LPG Industry Regulation Act
              </a>
            </li>
            <li>
              <a href="https://lawphil.net/statutes/repacts/ra1992/ra_7394_1992.html" target="_blank" rel="noopener noreferrer">
                Republic Act No. 7394, Consumer Act of the Philippines
              </a>
            </li>
            <li>
              <a href="https://lawphil.net/statutes/repacts/ra2023/ra_11967_2023.html" target="_blank" rel="noopener noreferrer">
            ...
            <li>
              <a href="https://www.dti.gov.ph/dti-consumer-space/dti-complaints/" target="_blank" rel="noopener noreferrer">
